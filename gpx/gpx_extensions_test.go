...
<gpx  xmlns="http://www.topografix.com/GPX/1/1" version="1.1" creator="https://github.com/vearutop/gpxgo">
       <metadata>
               <author></author>
               <extensions>
                       <aaa>
...
func TestCreateMetadataExtensionWithNamespace(t *testing.T) {
	...
	for n, g := range []GPX{original, *reparsed, *rereparsed} {
		...
		assert.Nil(t, err)
		expected := `<?xml version="1.0" encoding="UTF-8"?>
<gpx xmlns:ext="http://trla.baba.lan" xmlns="http://www.topografix.com/GPX/1/1" version="1.1" creator="https://github.com/vearutop/gpxgo">
       <metadata>
               <author></author>
               <extensions>
                       <ext:aaa>
